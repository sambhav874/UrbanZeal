...
export default function StoreItemTile({ onAddToCart, ...item }) {
  ...
  return (
    <div className="card flex flex-col w-72 h-120 p-8 text-white bg-gradient-to-br from-gray-200 to-gray-400 border-2 border-transparent rounded-lg transition-transform duration-600 cursor-pointer transform-origin-right-bottom shadow-lg hover:shadow-xl hover:duration-1000 hover:bg-gradient-to-br hover:from-gray-400 hover:to-gray-200 hover:scale-105">
