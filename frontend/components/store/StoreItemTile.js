...
export default function StoreItemTile({ onAddToCart, ...item }) {
  ...
  return (
    <div className="card flex flex-col w-80 h-128 p-8 text-white bg-gradient-to-br from-gray-200 to-gray-400 border-2 border-transparent rounded-lg transition-transform duration-600 cursor-pointer transform-origin-right-bottom shadow-lg hover:shadow-xl hover:duration-1000 hover:bg-gradient-to-br hover:from-gray-400 hover:to-gray-200 hover:scale-105">
      <div className="main-content flex-1">
        ...
        <div className="image-container flex justify-center items-center h-40">
          <img src={image} className="w-40 h-auto" alt={name} />
        </div>
