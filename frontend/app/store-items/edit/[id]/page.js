...
async function handleFormSubmit(ev) {
  ...
  if (!itemName || !itemPrice || !itemDescription || !itemCategory || !itemsubCategory || !image || sizes.length === 0) {
...
// ... (rest of the code remains unchanged)
  ...
  <div className="flex items-start gap-4" style={{ gridTemplateColumns: '3fr 7fr' }}>
    ...
    <div className="grow">
      ...
      <input type="text" value={itemName ? itemName : itemData.name} onChange={(e) => setItemName(e.target.value)} required />
      <label>Price</label>
      <input type="text" value={itemPrice ? itemPrice : itemData.price} onChange={(e) => setItemPrice(e.target.value)} required />
      <label>Description</label>
      <input type="text" value={itemDescription ? itemDescription : itemData.description} onChange={(e) => setItemDescription(e.target.value)} required />
      <label>Category</label>
      <select value={itemCategory ? itemCategory : itemData.category} onChange={(e) => setItemCategory(e.target.value)} required>
      ...
      <select value={itemsubCategory ? itemsubCategory : itemData.subcategory} onChange={(e) => setItemsubCategory(e.target.value)} required>
