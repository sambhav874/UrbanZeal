...
const Women = () => {
  ...
  useEffect(() => {
    ...
    fetch('/api/store-items')
      ...
      .then(items => {
        ...
        setItems(womenItems.slice( 0, 5)); 
        console.log(items)// Assuming you want the latest 5 items
      });
  ...
  return (
    <div className="max-w-4xl mx-auto mt-8 px-4 text-center">  <div className="text-4xl font-bold mb-8 store">Women</div>
        ...
        {subCategories.map(subcategory => (
          <div key={subcategory._id}>
            <Link href={`/products/Women/${subcategory.name}`}>
              <div className="border border-gray-200 rounded-md overflow-hidden shadow-md p-4">  <img src={subcategory.image} alt={subcategory.name} className="w-full h-60 object-cover" />
                <div className="mt-4">  <h3 className="text-xl font-semibold mb-2">{subcategory.name}</h3>
